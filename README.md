...
Также была опробована модель Faster R-CNN. С ней удалось достич mAP<sub>0.5</sub> = 0.394 , что меньше, чем у YOLOv5. Кроме того, Faster R-CNN обучается дольше, чем YOLOv5.

Помимо этого, была обучена модель YOLOv8. С ней удалось добиться mAP<sub>0.5</sub> = 0.701. Таким образом, это лучшая по качеству модель.
